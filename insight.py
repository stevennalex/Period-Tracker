...
def teks_olahraga():
    teks = '''    Seperti yang kita ketahui, nyeri pada saat haid memang menyebalkan. Namun, hal tersebut dapat kita atasi dengan berolahraga karena saat berolahraga tubuh akan melepaskan hormon endorfin sebagai pereda nyeri alami. Berikut merupakan contoh olahraganya:\n           
    1. Jalan santai
...
def makanan():
    text = '''    Saat mengalami gejala menstruasi yang terbilang ringan, dapat diatasi dengan memakan makanan yang mampu meredakan nyeri haid. Berikut merupakan makanan yang dapat meredakan nyeri haid:
    1.  Brokoli
