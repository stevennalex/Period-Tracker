...
# Mengubah gambar menjadi ukuran yang sesuai dengan jendela
image = Image.open("bg4.jpeg")
image = image.resize((window.winfo_screenwidth(), window.winfo_screenheight()))
image = image.resize((600, 900))  # Mengatur ukuran sesuai kebutuhan

# Konversi gambar menjadi format yang dapat ditampilkan oleh Tkinter
...
5. Pilates
    ...
    Berikut merupakan video yang bisa menjadi referensi dalam berolahraga pada saat nyeri haid:'''
                ,justify="left", wraplength=390)
text.pack()
# Membuat tombol
button = tk.Button(window, text="Rekomendasi Olahraga", command=on_button_click)
button.pack()
...
7.  Kacang-kacangan
    ...
    Berikut merupakan video rekomendasi olahan makanan yang dapat kamu coba saat merasakan nyeri haid:'''
                ,justify="left", wraplength=450)
text.pack()
# Membuat tombol
button = tk.Button(window, text="Rekomendasi makanan", command=on_button_click)
button.pack()
...
4. Child’s pose
    ...
    Berikut merupakan referensi dari posisi tidur yang membuat terasa lebih nyaman saat haid:
'''
                ,justify="left", wraplength=450)
text.pack()
# Membuat tombol
button = tk.Button(window, text="Rekomendasi posisi tidur", command=on_button_click)
button.pack()
